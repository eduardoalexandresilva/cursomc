...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Produto p10 = new Produto(null, "Pente",80.00);	
		Produto p11 = new Produto(null, "Shapo",80.00);	
		...
		cli1.getTelefones().addAll(Arrays.asList("34583166", "998747387"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt 203", "Jardim", "50960300", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "300", "Apt 203", "Jardim", "50960300", cli1, c2);
